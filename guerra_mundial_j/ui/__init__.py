...
Components:
    ...
    stats_panel.py   — StatsPanel: real-time statistics panel with visual
                       population bar, antidote progress bar, and counters.
    event_log.py     — EventLog: scrollable event log with timestamps
                       and colors by type (death, infection, alert, etc.).
    chart.py         — PopulationChart: scrolling line chart of human,
                       zombie, and infected counts over time.
"""
